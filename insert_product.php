...
if(isset($_POST['insert_product'])){
    ...
    || empty($product_price) || empty($district) || empty($product_email) || empty($product_contact) || empty($product_image1) || empty($product_image2) || empty($product_image3)){
        ...
        product_image1, product_image2, product_image3, product_price, district, product_email, product_contact, date, status) VALUES ('$product_title', '$description', '$product_keywords', '$product_category', '$product_brands',
        '$product_image1', '$product_image2', '$product_image3', '$product_price', '$district', '$product_email', '$product_contact', NOW(), '$product_status')";
    ...
    <div class="container mt-3">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="email" name="product_email" id="product_email" class="form-control" placeholder="Enter email address" 
                autocomplete="off" required="required">
            </div>
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_contact" id="product_contact" class="form-control" placeholder="Enter contact no" 
                autocomplete="off" required="required">
            </div>
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                autocomplete="off" required="not-required">
            </div>
