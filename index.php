...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <!-- second child -->
        <div class="bg-light">
            <h3 class="text-center p-2">Admin Details-(Admin)</h3>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
                ...
                <div class="button text-center">
                    ...
                    <button><a href="index.php?ads_pending" class="nav-link text-light bg-info my-1">Ads confirmation</a></button>
                    <button><a href="index.php?delete_info" class="nav-link text-light bg-info my-1">Delete Information</a></button>
...
<div class="container my-3">
            ...
            if(isset($_GET['ads_pending'])){
                include('ads_pending.php');
            }
