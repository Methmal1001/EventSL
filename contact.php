...
<div class="bg-light">
  ...
  <p class="text-center" style='font-weight:bold; color:#5F0A0A; font-size:20px;'>This is the best place to find your favoures.</p>
    ...
    if (isset($_POST["send"])) {
        ...
        $query = "INSERT INTO feedback_details (name, email, town, msg, date) VALUES (?, ?, ?, ?, ?)";
        ...
        mysqli_stmt_bind_param($stmt, "sssss", $name, $email, $town, $msg, $current_date);
