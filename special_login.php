...
<body>
    <div class="container-fluid m-3">
        <h2 class="text-center mb-5">SPManager Login</h2>
            ...
            <div class="col-lg-6 col-xl-4">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="form_outline mb-4">
                        ...
                        <input type="password" id="special_character" name="special_character" placeholder="Enter special_character" required="required" class="form-control">
                    </div>
                    <div>
